...
>((props, ref) => (
  <Unstyled.TabsTrigger
    ...
    {...props}
    className={cn(
      "text-fd-muted-foreground hover:text-fd-accent-foreground data-[state=active]:border-fd-primary data-[state=active]:text-fd-primary inline-flex items-center gap-2 whitespace-nowrap border-b border-transparent py-2 text-sm font-medium transition-colors disabled:pointer-events-none disabled:opacity-50 [&_svg]:size-4",
      props.className
    )}
  />
));
